# Shrinkwrap version 3.2

## Changes

1. The `packages[dependencyPath].dev` field is `false` when a dependency is neither a development dependency ONLY
of the top level module nor a transitive dependency of one.
